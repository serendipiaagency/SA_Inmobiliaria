  ...
  <div>
    <header class="border-b border-line bg-white">
      <div class="mx-auto max-w-screen-2xl px-6 pb-10 pt-12 lg:px-10">
        ...
        <h1 class="heading-serif mt-3 text-4xl md:text-5xl">Quiénes te acompañan</h1>
        <p class="mt-4 max-w-xl text-[15px] text-stone-500">Consultores especializados en el mercado inmobiliario de Dubái, listos para guiarte en cada paso.</p>
      </div>
    </header>
    <div class="mx-auto max-w-screen-2xl px-6 py-14 lg:px-10">
      ...
      <div v-else class="py-24 text-center">
        <p class="font-serif text-2xl text-stone-500">El equipo se está incorporando.</p>
        <NuxtLink to="/contact-us" class="btn-primary mt-6">Contáctanos</NuxtLink>
      </div>
    </div>
  </div>
</template>
