  ...
  const sections: HelpSection[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        'Usa exactamente el mismo Property Builder — el mismo componente, no una copia — por secciones numeradas que "Propiedades (web)": Información básica, Ubicación, Precio, Características, Descripción, Multimedia, Galería, Redes sociales y Comercial, adaptado a los campos de este catálogo (sin planos, tipos de unidad ni plan de pagos, al no aplicar a una vivienda de reventa individual). Crear y editar abren el mismo constructor; el estado de cada sección (completa/pendiente), el porcentaje de progreso, el guardado y el responsive funcionan exactamente igual que en Propiedades (web) — son el mismo código.',
        ...
        'La sección "Multimedia" admite vídeo por URL (YouTube, Vimeo o enlace directo) o subida de archivo, igual que Propiedades (web); "Galería" admite arrastrar para reordenar y "Usar como portada" para marcar la imagen principal.',
        ...
        'La sección "Comercial" tiene el mismo selector "Comercial asignado" (foto/iniciales, nombre, cargo) que Propiedades (web).',
        'La descripción se edita en inglés y árabe desde la sección "Descripción" (son las traducciones que ve el público, no hay un texto en un idioma único) — es la única diferencia real de contenido frente a Propiedades (web), ya que este catálogo nunca tuvo el editor de texto único de Propiedades (web).',
        'No existe plan de pagos en este catálogo: a diferencia de una promoción en construcción, una vivienda de reventa se vende con un único precio, sin fases de entrega.',
      ],
    },
    {
      key: 'agents',
