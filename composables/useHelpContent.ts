  ...
  const sections: HelpSection[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        '"Planos" funciona igual que en Propiedades (web): añade planos por categoría y tipo de unidad con su imagen — útil si la vivienda de reventa tiene un plano disponible, aunque no sea obligatorio.',
